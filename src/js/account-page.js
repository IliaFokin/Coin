...
// export async function renderAccountsPage(data) {
//   const accountList = el('ul.accounts__list');
//   const dropdownAccount = el('a.dropdown__link', {href: '?sort=account'}, 'По номеру');
//   const dropdownBalance = el('a.dropdown__link.dropdown__link--checked', {href: '?sort=balance'}, 'По балансу');
//   const dropdownTransaction = el('a.dropdown__link', {href: '?sort=transaction'}, 'По последней транзакции');
//   const dropdown = el('ul.accounts__dropdown', [
//     el('li.dropdown__item', dropdownAccount),
//     el('li.dropdown__item', dropdownBalance),
//     el('li.dropdown__item', dropdownTransaction),
//   ]);
...
// const accountList = el('ul.accounts__list');
//   const newAccountBtn = el('button.btn.accounts__btn', 'Создать новый счет');
//   const dropdownAccount = el('li.dropdown__item', 'По номеру');
//   const dropdownBalance = el('li.dropdown__item', 'По балансу');
//   const dropdownTransaction = el('li.dropdown__item', 'По последней транзакции');
//   const dropdown = el('ul.accounts__dropdown', [
...
//   dropdownAccount.addEventListener('click', () => {
//     sortAccountList('account');
//   })
  
//   dropdownBalance.addEventListener('click', () => {
//     sortAccountList('balance');
//   })
  
//   dropdownTransaction.addEventListener('click', () => {
//     sortAccountList('lastTransaction');
//   })
...
//       const accountDetails = await accountInfo(account.account, token).then(res => res.payload);
//       renderPage(renderAccountDetailsPage(accountDetails, token));
//     })
//   })

//   return container;

// router.on('/accounts/sort/account', () => {
//   console.log('test');
// })